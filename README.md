...
- Create generate image request
  ...
  {
    "id": 502,
    "processId": "c3092fdd-c6ad-4b8a-979d-56644ab38ef8",
    "createdAt": "2024-11-03T09:45:50.893+00:00",
    "updatedAt": "2024-11-03T09:45:50.893+00:00",
    "status": "IN_PROGRESS",
    "error": null,
    "details": {
      "id": 502,
...
- Find generation result by `processId`
  ```text
  curl -X 'GET' \
    'http://dev-cluster:8081/api/generation-results?processId=c3092fdd-c6ad-4b8a-979d-56644ab38ef8' \
  ...
  [
    {
      "id": "74fb9af8-ea2d-4466-a958-123fbb043db4",
      "relatedProcessId": "c3092fdd-c6ad-4b8a-979d-56644ab38ef8",
      "fileId": "ffd440db-7099-4f2f-b0bf-ca42fbd69e45"
    }
  ]
  ```
...
- Download generated image by `fileId`
  ```text
  curl -X 'GET' \
    'http://dev-cluster:8083/api/files/ffd440db-7099-4f2f-b0bf-ca42fbd69e45' \
    -H 'accept: image/png'
  ```
  Response:
- 
